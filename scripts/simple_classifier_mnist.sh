...
EXPERIMENT_DIR="${PROJECT_ROOT}/experiments/${EXPERIMENT_NAME:-simple_classifier_mnist}_${TIMESTAMP}"
...
OVERRIDES=(
  ...
  "experiment_name=${EXPERIMENT_NAME:-simple_classifier_mnist}"
  "experiment_dir=${EXPERIMENT_DIR}"
  "hydra.run.dir=${EXPERIMENT_DIR}"
  "trainer.max_epochs=${MAX_EPOCHS:-2}"
  "datamodule.batch_size=${BATCH_SIZE:-128}"
  "datamodule.num_workers=${NUM_WORKERS:-4}"
  "datamodule.data_dir=${DATA_DIR:-/mnt/c/data/MNIST}"
)
