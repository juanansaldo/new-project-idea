...
EXPERIMENT_DIR="${PROJECT_ROOT}/experiments/${EXPERIMENT_NAME:-simclr_imagenet}_${TIMESTAMP}"
mkdir -p "$EXPERIMENT_DIR"

export HYDRA_FULL_ERROR=1

OVERRIDES=(
  "--config-name=${CONFIG_NAME:-simclr_imagenet}"
  "experiment_name=${EXPERIMENT_NAME:-simclr_imagenet}"
