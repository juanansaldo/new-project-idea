...
EXPERIMENT_DIR="${PROJECT_ROOT}/experiments/${EXPERIMENT_NAME:-resnet18_cifar10}_${TIMESTAMP}"
mkdir -p "$EXPERIMENT_DIR"

export HYDRA_FULL_ERROR=1

OVERRIDES=(
  "--config-name=${CONFIG_NAME:-resnet18_cifar10}"
  "experiment_name=${EXPERIMENT_NAME:-resnet18_cifar10}"
